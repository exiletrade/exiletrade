var fm = (function (affixes) {
  ...
  function fm_processExplicitMods(item) {
    ...
    for (var idx in forgottenMods) {
      ...
      if (affix) {
        ...
        mod.tier = affix.tier;
        mod.minvalue = affix.minvalue;
        mod.maxvalue = affix.maxvalue;
  ...
  return {
    fm_process: fm_process,
    fm_processExplicitMods: fm_processExplicitMods,
    affixesLookup: affixesLookup,
    affixMaxLookUp: affixMaxLookUp
  };
}(fm_affixes));
